...
Sources: `.trellis/spec/backend/testing-quality.md`; `CLAUDE.md`;
...
`.trellis/spec/backend/api-cli-server.md`; `README.md`;
...
Sources: `.trellis/spec/backend/api-cli-server.md`;
...
commands. Sources: `.trellis/spec/backend/operations-security-logging.md`;
...
`.trellis/spec/backend/documentation-review.md`; `.trellis/workflow.md`;
...
- Did I update user-facing docs and Trellis specs together? Sources:
  `.trellis/spec/backend/documentation-review.md`; `README.md`; `docs/`.
- Did I run targeted tests for the boundary that changed? Sources:
  `.trellis/spec/backend/testing-quality.md`; `tests/`; `pyproject.toml`.
