...
Sources: `.trellis/spec/amc/backend/testing-quality.md`; `CLAUDE.md`;
...
`.trellis/spec/amc/backend/api-cli-server.md`; `README.md`;
...
Sources: `.trellis/spec/amc/backend/api-cli-server.md`;
...
commands. Sources: `.trellis/spec/amc/backend/operations-security-logging.md`;
...
`.trellis/spec/amc/backend/documentation-review.md`; `.trellis/workflow.md`;
...
- Did I update user-facing docs and Trellis specs together? Sources:
  `.trellis/spec/amc/backend/documentation-review.md`; `README.md`; `docs/`.
- Did I run targeted tests for the boundary that changed? Sources:
  `.trellis/spec/amc/backend/testing-quality.md`; `tests/`; `pyproject.toml`.
