...
| Simulation state, command rendering, snapshots | `server_ops.py` and its leaves (`server_ops_support.py`, `server_ops_parse.py`, `server_ops_profiles.py`, `server_command_render.py`, `server_k8s_objects.py`, `server_k8s_tables.py`, `server_k8s_api.py`, `server_k8s_api_trace.py`, `server_helm_impl.py`) |
