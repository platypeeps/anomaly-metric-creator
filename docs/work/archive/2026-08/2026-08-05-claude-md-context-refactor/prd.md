---
title: CLAUDE.md context-cost refactor
status: done
created: 2026-08-05
---
...
into docs/work. Recover the bodies from git history under `.trellis/tasks/archive/2026-08/08-05-claude-md-context-refactor`:
