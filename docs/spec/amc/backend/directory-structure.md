# Compatibility Pointer: Directory Structure
...
`docs/spec/amc/backend/index.md`; `docs/spec/amc/backend/architecture.md`;
`.agents/skills/trellis-before-dev/SKILL.md`.

Do not add new conventions here. Update `architecture.md` and the backend
index instead. Sources: `docs/spec/amc/backend/index.md`;
