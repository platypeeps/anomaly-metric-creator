...
`Scenario.id` must match its `SCENARIOS` key. Sources:
...
selection. Sources: `src/anomaly_metric_creator/legacy.py`;
`tests/test_scenarios.py`; `tests/test_registry.py`.
...
`duration_seconds`, or `shape_params`. Sources:
...
defaults. Sources: `src/anomaly_metric_creator/legacy.py`;
`tests/test_scenarios.py`.
...
component-disjoint drops are silent. Sources: `README.md`;
`src/anomaly_metric_creator/scenarios_impl.py`;
...
change. Sources:
`README.md`; `src/anomaly_metric_creator/scenario_catalog.py`;
`src/anomaly_metric_creator/legacy.py`;
...
Sources: `src/anomaly_metric_creator/catalog.py`;
...
explicitly intends to relock affected fixtures. Sources:
...
Sources: `tests/test_scenarios.py`;
...
Sources: `docs/topology.md`; `README.md`;
