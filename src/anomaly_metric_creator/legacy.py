...
from .csv_layout import _INSTANCE_DIMENSION_COLUMNS as _INSTANCE_DIMENSION_COLUMNS
...
# The eight _build_otlp_* payload builders moved verbatim to otlp.py
# (decomposition step 2); re-imported above at the _anomaly_event_id
# position so every historic ``legacy.<name>`` binding is preserved.
